---
title: 'Loading Phenotype Data in UK Biobank RAP: Command Line vs Jupyter Notebooks'
...
```bash
dx extract_dataset  --entities participant --list-fields | grep "22420"
```
...
The dictionary approach requires more setup - extracting CSVs, loading them into pandas, writing filter logic. It's worth it when you're building something meant to last, but not when you're exploring or need a quick answer.

## When I Actually Use the Dictionaries

That said, there are times when the dictionaries are nice for making sense of these table after extraction.
